...
const PartnerDetails = () => {
  ...
  useEffect(() => {
    axios(`https://study-mate-server-fawn.vercel.app/partners/${id}`).then(
      (res) => {
  ...
  const handleRequest = () => {
    ...
    axios
      .post(
        `https://study-mate-server-fawn.vercel.app/request/${details._id}`,
        requestDetails
      )
      .then((res) => {
        // console.log(res.data)
        ...
        setCount(!count);
        toast.success(
          "Data Will Be Saved on Database! Please Visit My Connection Page"
        );
      });
  };
  ...
  return (
    <div>
      <div className="w-10/12 mx-auto my-18 py-5 px-2 h-auto">
        <div
        ...
        >
          <figure className="w-full md:w-52 lg:w-72 rounded-sm h-82">
            <img
