...
import { MdDashboard, MdOutlineCreateNewFolder, MdPerson } from 'react-icons/md';
...
const UserSidebar = () => {
    return (
        <div className='flex flex-col gap-2 mt-2 '>
            ...
            <NavLink to='/dashboard'><Menu title={'My connections'} icon={<MdDashboard />}>Dashboard</Menu></NavLink>
